...
function SessionBuilder(storage, remoteAddress) {
  ...
  console.log('SESSION BUILDER ADDRESS')
  console.log(this.remoteAddress.toString())
}
  ...
  processPreKey: function(device) {
    ...
    return SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
      return this.storage.isTrustedIdentity(
        ...
        console.log(device.identityKey)
        console.log( device.signedPreKey.publicKey)
        console.log(device.signedPreKey.signature)
