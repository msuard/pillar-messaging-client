...
SessionCipher.prototype = {
  ...
  decryptWhisperMessage: function(buffer, encoding) {
    ...
    console.log(base64.decode(atob(buffer)))
    ...
    return SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
      ...
      return this.getRecord(address).then(function(record) {
        ...
        console.log(record.getSessions())
        console.log('DONE')
  ...
  doDecryptWhisperMessage: function(messageBytes, session) {
    console.log('DODECRYPTWHISPERMSG')
    var base64 = require('base-64');
    var atob =require('atob')
    //console.log(atob(messageBytes))
    //console.log(base64.decode(atob(messageBytes)))
    ...
    console.log(atob(messageProto))
    //console.log(base64.decode(atob(messageProto)))

    var mac = messageBytes.slice(messageBytes.byteLength - 8, messageBytes.byteLength);
    console.log(mac)
    console.log(atob(mac))
    //console.log(base64.decode(atob(mac)))

    var message = protobuf.WhisperMessage.decode(messageProto); ////ERROR HERE//////////////////////////////////////////////////////////////////////////////////
    console.log('MESSAGE')
    console.log(message)
    var remoteEphemeralKey = message.ephemeralKey.toArrayBuffer();
  //onsole.log(remoteEphemeralKey)
